  ...
  return (
    <div className="min-h-screen bg-cloth pb-28">
      <header className="bg-navy text-white sticky top-0 z-20 border-b border-white/10">
        <div className="max-w-3xl mx-auto px-4 pt-4 pb-3 flex flex-col md:flex-row md:items-start justify-between gap-4">
          <div className="flex-1">
            <div className="flex items-start justify-between">
              <h1 className="text-lg font-bold tracking-tight">{settings?.shopName || "Supreme Sanitary"}</h1>
              <a
                href="/shop"
                className="text-xs text-white/50 border border-white/20 rounded-full px-3 py-1.5 whitespace-nowrap md:hidden"
              >
                Shop login
              </a>
            </div>
            <p className="text-white/60 text-[11px] sm:text-xs leading-snug mt-1 max-w-xl">
            ...
            <div className="mt-3 text-sm flex flex-col gap-1.5">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-white/90">
                {(() => {
                  ...
                  return (
                    <>
                      <a href={`https://wa.me/${n1.replace(/\+/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-white transition">
                      ...
                      <a href={`tel:${n2}`} className="flex items-center gap-1.5 hover:text-white transition">
              ...
              <div className="flex items-start gap-1.5 mt-1 text-white/60">
                <svg className="w-4 h-4 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                <span className="text-[11px] sm:text-xs leading-snug max-w-lg">{settings?.address || "Shop No.1, Happy Apartment, Rajiv Gandhi Civic Centre, Near Lokendra Talkies, New Road, Ratlam (457001) M.P."}</span>
              </div>
            </div>
          </div>
          <a
            href="/shop"
            className="hidden md:inline-flex text-xs text-white/50 border border-white/20 rounded-full px-3 py-1.5 whitespace-nowrap mt-1"
          >
            Shop login
          </a>
        </div>
